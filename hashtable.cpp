...
int main() {
    ...
    std::cout << "Find key 42 (missing): " << (ht.find(42) ? *ht.find(42) : "not found") << "\n";
    ...
    std::cout << "Remove key 2: "
              << (ht.remove(2) ? "success" : "fail") << "\n";
    std::cout << "Find key 2: " << (ht.find(2) ? *ht.find(2) : "not found") << "\n";
    ...
    std::cout << "Find random key 123: "
              << (bigHT.find(123) ? std::to_string(*bigHT.find(123)) : "not found")
              << "\n";
    std::cout << "Find random key 456: "
              << (bigHT.find(456) ? std::to_string(*bigHT.find(456)) : "not found")
              << "\n";
    std::cout << "Find random key 789: "
              << (bigHT.find(789) ? std::to_string(*bigHT.find(789)) : "not found")
              << "\n";
